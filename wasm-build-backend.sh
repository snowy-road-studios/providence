...
PROV_HOST_ADDR=providence-prealpha-backend-0.online:48888 PROV_HOST_IS_WSS=true PROV_CONFIG_DIR=config cargo build -p client --target wasm32-unknown-unknown --release
